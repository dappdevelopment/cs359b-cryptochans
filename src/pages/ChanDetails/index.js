    ...
    // See utils/getWeb3 for more info.
      ...
      this.ChanCoreContract.checkInTimer().then(checkInTimer => {
        this.ChanCoreContract.getChan(selectedId).then(result=> {console.log('chan:',result); 
          ...
          this.setState({level:result[2].toNumber()});
          this.setState({generation:result[3].toNumber()});
          this.setState({maxLevel:(result[3].toNumber() + 1) * 10});
          ...
          this.setState({difficult_level:500*(result[2].toNumber()+1)});
